...
public class RoleController {
    ...
    public ResponseResult findResourceListByRoleId(Integer roleId){
        List<ResourceCategory> resourceCategories = roleService.findResourceCategoryByRoleId(roleId);
        List<Resource> resources = roleService.findResourceByRoleId(roleId);
        for(ResourceCategory resourceCategory:resourceCategories){
            ...
            resourceCategory.setResourceList(resourcesList);
        }

        ResponseResult responseResult = new ResponseResult(true, 200, "响应成功", resourceCategories);
        return  responseResult;
